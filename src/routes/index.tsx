...
const board = [
  { name: "Professor Yifru Berhan Mitke", role: "Board Chairperson", photo: "", bio: "A distinguished OB-GYN specialist, medical researcher, and public health leader with over 29 years of clinical, teaching, and executive leadership experience. Currently Professor of Obstetrics and Gynecology, Consultant and Researcher at St. Paul's Hospital Millennium Medical College in Addis Ababa, and Scientific Advisor to the HaSET maternal and child health research program. Former Minister of Health of Ethiopia (2016–2018) and College Head with Vice President rank at Addis Ababa University and Hawassa University. Co-author of 86+ peer-reviewed publications shaping maternal and neonatal health policy across East Africa." },
