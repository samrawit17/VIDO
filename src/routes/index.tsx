...
const boardPhotos: Record<string, string> = {
  ...
  "Mr. Tadesse Atlabachew Abegaz (PhD candidate) ": tadesseImg,
        ...
        <div className="container-editorial">
          ...
          <div className="grid gap-3 max-w-3xl mx-auto">
            {[
              ...
              { l: "Executive Director", d: "Daily Operations · Mr. Tadesse Atlabachew Abegaz (PhD candidate) " },
            ].map((n, i) => (
