...
const board = [
  { name: "Professor Yifru Berhan Mitke", role: "Board Chairperson", photo: "", bio: "Former Minister of Health of Ethiopia, distinguished OB-GYN specialist, medical researcher, and public health leader with over 29 years of clinical, teaching, and executive leadership experience. Currently, he serves as a Professor of Obstetrics and Gynecology, Consultant, and Researcher at St. Paul's Hospital Millennium Medical College in Addis Ababa, as well as a Scientific Advisor for the HaSET maternal and child health research program. His extensive career is highlighted by high-level governance roles, most notably serving as the Minister of Health of Ethiopia (2016–2018) and as a College Head with Vice President rank at both Addis Ababa University and Hawassa University. A prolific academic, he has co-authored over 86 peer-reviewed publications that continue to shape maternal and neonatal health policies across East Africa." },
