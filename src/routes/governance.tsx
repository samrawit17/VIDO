            ...
            <div className="border-l-4 border-gold p-5 bg-background shadow-sm ml-16">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground uppercase tracking-widest">Daily Operations · Mr. Tadesse Atlabachew Abegaz (PhD candidate) </div>
                </div>
              </div>
